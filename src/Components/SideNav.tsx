...
export default function SideNav() {
    ...
    return (
        <div className={`${isMenuClicked ? 'translate-x-0 w-[180px] shadow' : '-translate-x-full w-0'} fixed top-0 bg-white dark:bg-emerald-900 dark:text-emerald-200 text-emerald-700 transition-all ease-linear duration-300 min-h-screen overflow-x-hidden overflow-y-scroll flex justify-center p-4`}>
